...
<section class="seccion contenedor">
  ...
  <form action="pago.php" id="registro" class="registro" method="post">
        ...
        <li>
          <div class="tabla-precio">
            ...
            <div class="orden">
              ...
              <input type="number" min="0" id="pase_dia" size="3" name="boletos[undia][cantidad]" placeholder="0">
              <input type="hidden" name="boletos[undia][precio]" value="30">
            </div>
          </div>
        </li>
        <li>
        ...
        <li>
          <div class="tabla-precio">
            ...
            <div class="orden">
              ...
              <input type="number" min="0" id="pase_dosdias" size="3" name="boletos[dosdias][cantidad]" placeholder="0">
